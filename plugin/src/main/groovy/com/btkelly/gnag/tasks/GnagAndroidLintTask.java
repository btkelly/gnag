...
public class GnagAndroidLintTask extends BaseGnagCheckTask implements ViolationResolver {
    ...
    public static BaseGnagCheckTask addTask(ProjectHelper projectHelper, GnagPluginExtension gnagPluginExtension) {
        ...
        taskOptions.put(Task.TASK_TYPE, GnagAndroidLintTask.class);
        ...
        GnagAndroidLintTask gnagCheckTask = (GnagAndroidLintTask) project.task(taskOptions, TASK_NAME);
    ...
    public void resolve(Project project) {
        violationDetectors.add(ViolationDetectorFactory.getAndroidLintViolationDetector(project, gnagPluginExtension));
    }
}
